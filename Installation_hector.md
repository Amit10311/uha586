...
$ cd ~/catkin_ws/src
```
5. Copy packages from **hector** folder 
```
$ cd ~/catkin_ws/src
cp -R ~/hector/src/load_octomap/ ~/catkin_ws/src
cp -R ~/hector/src/takeoff_land/ ~/catkin_ws/src
cp -R ~/hector/src/hector-moveit/ ~/catkin_ws/src
```
5. Git clone packages and compile
```
$ cd ~/catkin_ws/src
